...
To view events of your {{site.data.keyword.ihsdbaas_mongodb_full}} service instance, you need to have an {{site.data.keyword.cloudaccesstrailshort}} instance in the same region, as the following table shows:
...
| `hyperp-dbaas-mongodb.cluster.resource.scale` | Scale cluster resources |
