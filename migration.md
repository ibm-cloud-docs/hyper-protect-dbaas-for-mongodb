...
|*cert_file*|The [certificate authority (CA)](#x2016383){: term} file in the `.pem` format that you downloaded from the **Manage** page on the service dashboard. Specify it with a relative or absolute path.|./cert.pem|
...
|Parameter|Description|Example|
|---------|-----------|-------|
|*cluster_name*|The {{site.data.keyword.mongodb}} cluster name that you set when you create the service instance. You can find the **Cluster name** on the **Manage** page on the service dashboard. The name is the value after `replicaSet=`.||MongoDB-002|
|*host_name_i*|The name of the host server that hosts the targeting node. One primary node and two secondary nodes are available in each cluster. You can find the hostnames on the **Manage** page on the service dashboard.|dbaas29.hyperprotectdbaas.cloud.ibm.com, dbaas31.hyperprotectdbaas.cloud.ibm.com, dbaas30.hyperprotectdbaas.cloud.ibm.com|
|*port_i*|The port to connect the corresponding host. You can find the port numbers on the **Manage** page on the service dashboard.|28128, 28248, 28043|
...
|*cert_file*|The certificate authority (CA) file in the `.pem` format that you downloaded from the **Manage** page on the service dashboard. Specify it with a relative or absolute path.|./cert.pem|
